...
<dt><a href="#QuotientAndRemainder">type: QuotientAndRemainder</a> → <code>object</code></dt>
<dd><p>Contains integer quotient and remainder of a division.</p>
</dd>
<dt><a href="#Rational">type: Rational</a> → <code><a href="#Q">Q</a></code> | <code>number</code></dt>
<dd><p>A number or an instance of a <code>Q</code>.</p>
</dd>
<dt><a href="#RoundingMode">type: RoundingMode</a> → <code>string</code></dt>
...
* [class: Q](#Q)
  ...
  * _static_
    ...
    * [const: .MAX_EXP](#Q.MAX_EXP) → <code>number</code>
    * [const: .MAX_PRIME](#Q.MAX_PRIME) → <code>number</code>
    * [const: .MIN_EXP](#Q.MIN_EXP) → <code>number</code>
...
<a name="Q.MAX_EXP"></a>
### const: Q.MAX_EXP → <code>number</code>
...
### const: Q.MAX_PRIME → <code>number</code>
...
<a name="Q.MIN_EXP"></a>
### const: Q.MIN_EXP → <code>number</code>
...
## type: QuotientAndRemainder → <code>object</code>
...
## type: RoundingMode → <code>string</code>
