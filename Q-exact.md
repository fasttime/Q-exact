...
* [type: QuotientAndRemainder](#QuotientAndRemainder) → <code>object</code>
* [type: Rational](#Rational) → <code>[Q](#Q)</code> \| <code>number</code>
* [type: RoundingMode](#RoundingMode) → <code>string</code>
