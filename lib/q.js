 ...
 * @throws Invalid argument error if the argument cannot be converted to a finite numeric value.
 * @classdesc
...
(function (self)
{
    ...
    var qDivide =
        function (op)
        {
            ...
            return multiplyFactors(this, op, subtract);
        };
