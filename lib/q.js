...
(function ()
{
    ...
    function (options)
    {
        function prependSign(str)
        {
            var result = (sign < 0 ? '-' : '') + str;
            return result;
        }
        ...
        if (mode === 'fraction')
        {
            if (sign)
            {
                ...
                {
                    result =
                    prependSign(denominator !== 1 ? numerator + '/' + denominator : numerator);
                }
            }
            else
                result = 0 + '';
