...
(function (self)
{
    ...
    function decompose(factors1, factors2)
    {
        ...
        var norm1 = oddProduct1 * binPow(binDiff1);
        var binDiff2 = getExp(factors2, 2) - getExp(factors, 2);
        var norm2 = oddProduct2 * binPow(binDiff2);
