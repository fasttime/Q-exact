...
(function (self)
{
    ...
    function addFactors(op1, op2, operation)
    {
        ...
        if (sign1 && sign2)
        {
            ...
            var numerator = getCommonNumerator(op1, op2, operation, factors);
    ...
    function getCommonNumerator(op1, op2, operation, factors)
    {
        var factor;
        ...
        var result = operation(product1, product2);
        if (operation(product1 - result, product2) !== 0)
        {
            throwArithmeticOverflow();
        }
        return result;
    ...
    var qCompareTo =
        function (op)
        {
            ...
            {
                var numerator = getCommonNumerator(this, op, subtract, createFactors());
